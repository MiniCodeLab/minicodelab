# Conceptos base y fundamentos de React - Parte 2
...
Una vez tenemos nuestro mock podemos crear un state que se inicia con este conjunto de datos. Recordad que hablamos de los `state` por encima en la primera parte de estos posts **[TODO: añadir enlace cuando lo tengamos]**
