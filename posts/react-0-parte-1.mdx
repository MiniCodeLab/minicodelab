# Conceptos base y fundamentos de React - Parte 1
...
### Diferencias entre librería y Framework [TODO: usar imagenes propias]
...
### \*Ciclo de Vida de un Componente [Imagen propia]
...
### Componetización en React [usar imagen propia]
...
### Cómo creamos un proyecto en React [usar imagen propia]
